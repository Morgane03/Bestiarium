...
class MonsterController
{
    ...
    function addCreature(array $datas = []): void
    {
        try {
            ...
            renderPage('user', ['creatures' => $this->getCreatures($_SESSION['user_id'])]);
        } catch (PDOException $e) {
    ...
    {
        $prompt = file_get_contents('includes\pollinations\monster.description.prompt');
